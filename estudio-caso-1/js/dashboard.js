document.addEventListener('DOMContentLoaded', function(){
    ...
    function loadTasks(){
        ...
        tasks.forEach(function(task){
            ...
            if (task.comments && task.comments.length > 0) {
                task.comments.forEach((comment, index) => {
                    commentsHtml += `
                    <div class="comment-item d-flex justify-content-between align-items-center mb-1">
                        <span class="comment-text small text-muted">${comment}</span>
                        <a href="#" class="small ms-2 delete-comment" data-task-id="${task.id}" data-comment-index="${index}">Remove</a>
                    </div>`;
                });
            }
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="comments-section mt-3">
                        <h6 class="comments-title small fw-bold">Comments</h6>
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-outline-primary btn-sm add-comment" data-id="${task.id}">Add</button>
                        </div>
                    </div>
                </div>
        ...
        document.querySelectorAll('.delete-comment').forEach(function(removeLink){
    ...
    function handleAddComment(event) {
        ...
        const commentInputElement = event.target.parentElement.querySelector('.comment-input');
